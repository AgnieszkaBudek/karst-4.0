...
#ifndef KARST_4_0_VTK_BY_HEAND_H
#define KARST_4_0_VTK_BY_HEAND_H

namespace karst{

    //TODO: Write a simple output in VTK file. Can be an defoult input/output format
...
#endif //KARST_4_0_VTK_BY_HEAND_H
